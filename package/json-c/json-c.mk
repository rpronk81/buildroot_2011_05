...
define JSON_C_INSTALL_STAGING_CMDS
   @if [ ! -d "$(BR2_HOST_DIR)/usr/arm-unknown-linux-gnueabi/sysroot/usr/include/json" ]; \
   then \
   ...
   cp -p output/build/json-c-0.10-20120530/libjson.*  /opt/buildroot-2011.05/usr/arm-unknown-linux-gnueabi/sysroot/usr/lib
endef
